...
<form name="aspnetForm" method="post" action="social.aspx" id="aspnetForm">
<input type="hidden" name="MSO_PageHashCode" id="MSO_PageHashCode" value="241" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUBMGRkcl7dYh+40hAtf81tcF46W+CqSYM=" />
  ...
  <tr>
    <td class="MSC_PrimaryNavLinkFrame-On"><a href="./social.aspx" class="MSC_PrimaryNavLink-On">Social</a><table cellpadding="0" cellspacing="0" class="MSC_SecondaryNavFrame">
        <tr>
          <td class="MSC_SecondaryNavLinkFrame"><a href="./barbatmitzvah.aspx" class="MSC_SecondaryNavLink">Bar or Bat Mitzvah</a></td>
        </tr>
        <tr>
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent" id="IWS_WH_Zone1"><div id="General_Content"><strong><img src="images/wintercapresesalad.jpg" style="FLOAT: left; MARGIN: 12px 12px 12px 0px; WIDTH: 173px; HEIGHT: 155px"/>Planning + Creative Menus + Personal Service = The Perfect Party</strong></div><div>If you are planning a shower, bar or bat mitzvah, birthday party, anniversary party, or any other party Deco will take care of all the details so that you can be a guest at your own party.  Give us a call today at 913.262.2816 or by email at <a href="mailto:courtney@decocateringkc.com">courtney@decocateringkc.com</a> to start planning the perfect party!</div></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table></div>
					</div>
				</td>
			</tr></table>
			</td>
