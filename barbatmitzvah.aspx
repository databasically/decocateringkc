...
<head>
	<title>Bar or Bat Mitzvah</title><meta name="Keywords" content="bar mitzvah, caterting, bar mitzvah catering, bat mitzvah catering, kosher catering, kansas city catering, full service catering, jewish catering, celebration" /><meta name="Description" content="Deco Catering has creative ideas to make your child's Bar or Bat Mitzvah a celebration that everyone will love.  Contact us today to start planning your menu." />
...
<form name="aspnetForm" method="post" action="barbatmitzvah.aspx" id="aspnetForm">
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUBMGRkcl7dYh+40hAtf81tcF46W+CqSYM=" />
  ...
  <tr>
    <td class="MSC_PrimaryNavLinkFrame-On"><a href="./social.aspx" class="MSC_PrimaryNavLink-On">Social</a><table cellpadding="0" cellspacing="0" class="MSC_SecondaryNavFrame">
        <tr>
          <td class="MSC_SecondaryNavLinkFrame-On"><a href="./barbatmitzvah.aspx" class="MSC_SecondaryNavLink-On">Bar or Bat Mitzvah</a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="MSC_SecondaryNavLinkFrame"><a href="./birthdayparty.aspx" class="MSC_SecondaryNavLink">Birthday Party</a></td>
        </tr>
        <tr>
          <td class="MSC_SecondaryNavTopSpace"></td>
        </tr>
        ...
        <tr>
          <td class="MSC_SecondaryNavLinkFrame"><a href="./shower.aspx" class="MSC_SecondaryNavLink">Shower</a></td>
        </tr>
      </table>
    </td>
  </tr>
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent" id="IWS_WH_Zone1"><div id="General_Content">As you've probably heard, planning this special day for your son or daughter can be stressful.  Deco can make the planning fun with unique menu ideas for the adults and the kids.  We'll work with you to create a one-of-a-kind party that your friends and family will remember for years to come.  Call us today at 913.262.2816 or send her an email at <a href="mailto:courtney@decocateringkc.com">courtney@decocateringkc.com</a> to set up your consultation today!</div></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table></div>
					</div>
				</td>
			</tr></table>
			</td>
