...
<head>
	<title>About Us</title><meta name="Keywords" content="catering, local food, small company, Kansas City, local residents" /><meta name="Description" content="Deco Catering is a mother/daughter team serving the Kansas City are.  We are committed to local vendors, food, and the community in which we live and do business." />
...
<input type="hidden" name="MSO_PageHashCode" id="MSO_PageHashCode" value="581" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUBMGRkcl7dYh+40hAtf81tcF46W+CqSYM=" />
  ...
  <tr>
    <td class="MSC_PrimaryNavLinkFrame-On"><a href="./aboutus.aspx" class="MSC_PrimaryNavLink-On">About Us</a></td>
  </tr>
  <tr>
    <td class="MSC_PrimaryNavTopSpace"></td>
  </tr>
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent" id="IWS_WH_Zone1"><div class="F_Mid" id="AboutUs_Title" style="FONT-SIZE: 20px">About Us </div><p align="center"><img src="images/terricoco.jpg"/></p><p align="center"><font face="Arial, Geneva, sans-serif">Terri Rich &amp; Courtney Saye  -  co-owners</font></p><div><font face="Arial, Geneva, sans-serif"> </font></div><div id="AboutUs_ContentTip1"><p><font face="Arial, Geneva, sans-serif" size="2">Deco Catering was born in early 2009 out of a long time dream and passion for food and entertaining by co-owners and mother-daughter team; Terri Rich and Courtney Saye. We love what we do, and it shows in our food, service, and overall events. Together with our culinary team and professional staff, we will ensure the success of your event. We specialize in custom weddings &amp; events where every detail matters. </font></p><p><font face="Arial, Geneva, sans-serif"><hr/></font></p><p/><p/><p/><p/><p/><p/><p/><p/><p/><p/><p/><p/><p/></div><div id="AboutUs_CompanyHistory_Title"><b><font face="Arial, Geneva, sans-serif">Our Mission</font></b></div><div id="AboutUs_CompanyHistory_Content"><font face="Arial, Geneva, sans-serif"><font size="2">Deco Catering's mission is to provide the customer with creative, fresh menu options, and unsurpassed personal service.  We offer the highest quality food and excellent customer service through a simple approach to the catered event. </font> </font></div><div id="AboutUs_CustomerTestimonials_Title"><font face="Arial, Geneva, sans-serif"> </font></div><font face="Arial, Geneva, sans-serif"> </font></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table></div>
					</div>
				</td>
			</tr></table>
			</td>
