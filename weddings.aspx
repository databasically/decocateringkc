...
<head>
	<title>Weddings</title><meta name="Keywords" content="kansas city wedding caterers, kansas city wedding catering, awrence, desoto, eudora, olathe, lenexa, overland park, shawnee, mission, roeland park, kansas city, fairway, Westwood, Prairie Village, the Plaza, downtown, midtown, unique wedding catering, action stations, modern buffet displays, modern decor, made from scratch menus, professional servers, the knot, excellent customer service, affordable wedding catering, creative wedding catering, custom wedding catering" /><meta name="Description" content="Deco loves weddings.  Let our professionals help make your day a special one that you and all of your guests will remember fondly for years to come.  Our made from scratch menus, artistic presentation, and amazing service will amaze you." />
...
<input type="hidden" name="MSO_PageHashCode" id="MSO_PageHashCode" value="981" />
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent" id="IWS_WH_Zone1"><div align="center" id="General_Content"><strong><font face="Arial, Geneva, sans-serif">Total Event Coordination, Amazing Food, Unmatched Service</font></strong></div><div align="center"> </div><p align="center"><font face="Arial, Geneva, sans-serif">  <div> <img src="images/Tablesettings.jpg"/></div> <div><br> </div><div><font face="Arial, Geneva, sans-serif">Your wedding day is a very special day, and your catering experience for the day should be too.    Deco will work with you to create a meal that looks as good as it tastes.  Our presentation is clean, modern, and sleek.  We have many unique options including our chef manned action stations, fun appetizers, and sleek, modern buffets.  We work closely with each of our couples, leaving no detail of the reception untouched.</font></div><div><br> </div><div><font face="Arial, Geneva, sans-serif">Regardless of menu selection, your reception will be staffed with a team of professional, uniformed servers who will help ensure your day is as perfect as you've always dreamed it would be.  Look over our menus, but keep in mind that we can also prepare a custom menu to fit your individual tastes, budget, and style.  Browse our sample menus &amp; service levels to decide what's right for you.</font></div> <div><br> </div><div><font face="Arial, Geneva, sans-serif">Give us a call at 913.262.2816 or send Courtney an email at <a href="mailto:courtney@decocateringkc.com">courtney@decocateringkc.com</a> to schedule a consultation today!</font> </div></font></p><p/><p/><p/><p/><p/><p/><p/><p/><blockquote style="MARGIN-RIGHT: 0px"> <div><br> </div></blockquote></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table></div>
					</div>
				</td>
			</tr></table>
			</td>
