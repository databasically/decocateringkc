...
<form name="aspnetForm" method="post" action="DecoFoodTruck.aspx" id="aspnetForm">
<input type="hidden" name="MSO_PageHashCode" id="MSO_PageHashCode" value="151" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUBMGRkcl7dYh+40hAtf81tcF46W+CqSYM=" />
  ...
  <tr>
    <td class="MSC_PrimaryNavLinkFrame-On"><a href="./DecoFoodTruck.aspx" class="MSC_PrimaryNavLink-On">Deco Street Eats</a></td>
  </tr>
  <tr>
    <td class="MSC_PrimaryNavTopSpace"></td>
  </tr>
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent"><div class="F_Mid" id="AboutUs_Title" style="FONT-SIZE: 20px"><font color="#310500"><font size="4">Street Eats serves up delicious lunches across the city &amp; serves at special events. Menus change daily, but there is typically a hot special, fresh sandwiches, salad, &amp; occasionally a soup. Follow us on Twitter @DecoStreetEats or become a fan on Facebook to see what we're up to</font>!</font></div></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 10%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent"><p align="center"><img src="images/StreetEats.jpg" style="WIDTH: 212px; HEIGHT: 171px"/></p></div></td><td style="WIDTH: 77%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 10%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent">
