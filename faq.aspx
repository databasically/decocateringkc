...
<input type="hidden" name="MSO_PageHashCode" id="MSO_PageHashCode" value="411" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUBMGRkcl7dYh+40hAtf81tcF46W+CqSYM=" />
  ...
  <tr>
    <td class="MSC_PrimaryNavLinkFrame-On"><a href="./faq.aspx" class="MSC_PrimaryNavLink-On">FAQ</a></td>
  </tr>
  <tr>
    <td class="MSC_PrimaryNavTopSpace"></td>
  </tr>
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent" id="IWS_WH_Zone1"><div class="F_Mid" id="FAQPage_Intro1" style="FONT-SIZE: 20px">FAQ </div><div id="FAQPage_Intro2"> </div> <div><br> </div><div class="F_Mid" id="FAQPage_SampleFAQ1a" style="FONT-SIZE: 12px"><b>Q: Why should I choose Deco Catering for my event?</b> </div><div id="FAQPage_SampleFAQ1Ans"><b>A:</b> Deco has the expertise and professionalism to ensure your event is a success.  We offer a fresh menu that uses local products whenever possible and we utilize green business practices. </div><hr style="HEIGHT: 1px"/><div class="F_Mid" id="FAQPage_SampleFAQ3a" style="FONT-SIZE: 12px"><a id="whatkind"><b>Q: Is there a delivery fee for drop off orders?</b></a> </div><div id="FAQPage_SampleFAQ3Ans"><b>A:</b> Yes, it averages $20, but please inquire with your address for an exact charge.</div><hr style="HEIGHT: 1px"/><div class="F_Mid" id="FAQPage_SampleFAQ4a" style="FONT-SIZE: 12px"><b>Q: Is there a minimum order?</b></div><div id="FAQPage_SampleFAQ4Ans"><b>A:</b> Yes, our minimum order is for 25 people for weekday breakfast and lunch, and varies on weddings and special events.</div><hr style="HEIGHT: 1px"/><div class="F_Mid" id="FAQPage_SampleFAQ5a" style="FONT-SIZE: 12px"><a id="whatnot"><b>Q:</b></a> <strong>What is the easiest way to contact Deco?</strong></div><div id="FAQPage_SampleFAQ5Ans"><b>A:</b> For weddings or social events call Courtney at 913.262.2816 or send her an email at <a href="mailto:courtney@decocateringkc.com">courtney@decocateringkc.com</a>.  For corporate orders you can call Terri at 913.262.2816 or email her at <a href="mailto:terri@decocateringkc.com">terri@decocateringkc.com</a>. </div></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table></div>
					</div>
				</td>
			</tr></table>
			</td>
