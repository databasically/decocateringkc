...
<form name="aspnetForm" method="post" action="Servicelevel.aspx" id="aspnetForm">
<input type="hidden" name="MSO_PageHashCode" id="MSO_PageHashCode" value="271" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUBMGRkcl7dYh+40hAtf81tcF46W+CqSYM=" />
  ...
  <tr>
    <td class="MSC_PrimaryNavLinkFrame-On"><a href="./weddings.aspx" class="MSC_PrimaryNavLink-On">Weddings</a><table cellpadding="0" cellspacing="0" class="MSC_SecondaryNavFrame">
        ...
        <tr>
          <td class="MSC_SecondaryNavLinkFrame-On"><a href="./Servicelevel.aspx" class="MSC_SecondaryNavLink-On">Service Options</a></td>
        </tr>
        <tr>
          <td class="MSC_SecondaryNavTopSpace"></td>
        </tr>
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent"><div id="General_Content"><p style="TEXT-ALIGN: justify; MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><i style="mso-bidi-font-style: normal"><span style="FONT-FAMILY: Arial; COLOR: black; mso-bidi-font-weight: bold"><font size="3">Service </font></span></i></p><p style="TEXT-ALIGN: justify; MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><i style="mso-bidi-font-style: normal"><span style="FONT-FAMILY: Arial; COLOR: black; mso-bidi-font-weight: bold">You will receive 6 free hours of consultation &amp; event coordination services from our owners to ensure no detail is left untouched.<span style="mso-spacerun: yes"> A 19% service charge covers logistics, overhead, &amp; other house costs.  This is not a gratuity.</span><b> <p/></b></span></i></p><p style="TEXT-ALIGN: justify; MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><span style="FONT-FAMILY: Arial; COLOR: black; mso-bidi-font-weight: bold"><p> </p></span></p><p/><p/><p/><p style="TEXT-ALIGN: justify; MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><i style="mso-bidi-font-style: normal"><span style="FONT-FAMILY: Arial; COLOR: black; mso-bidi-font-weight: bold">Deco's team is always professional &amp; strives for perfection on every single event.<span style="mso-spacerun: yes">  </span>We have no full time servers.<span style="mso-spacerun: yes">  </span>Our servers work with us in their own time because they love the work &amp; making our clients happy.<span style="mso-spacerun: yes">  </span>Our staff all comes to us through referrals &amp; our clients are always impressed. <p/></span></i></p></div><div><hr/></div><div><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><i style="mso-bidi-font-style: normal"><span style="FONT-FAMILY: Arial; mso-bidi-font-weight: bold"><span style="mso-tab-count: 1">              </span><p/></span></i></p><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal">  </p><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><span><strong>Cake Cutting - </strong><em>$1.50 per guest</em></span> </p><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><span><em>We will set up the cake table with a linen color of your choosing &amp; tea lights.  We will also provide a bottle of champagne, toasting glasses for the bride &amp; groom, cake knife &amp; server, plastic plates, forks, &amp; napkins.  Our professional servers will serve the cake.</em> </span></p><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"> </p><span><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><b style="mso-bidi-font-weight: normal"><span style="FONT-FAMILY: Arial">Coffee &amp; Other N/A Drink Service - </span></b><span style="FONT-FAMILY: Arial">$<i style="mso-bidi-font-style: normal">1.00-2.00 per guest <p/></i></span></p><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><i style="mso-bidi-font-style: normal"><span style="FONT-FAMILY: Arial">Let us know what you'd like to serve for an exact price.<span style="mso-spacerun: yes">  </span>You can do these services for a percentage of your guests (ex: Coffee service for 50 on a guest count of 200). <p/></span></i></p><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><b style="mso-bidi-font-weight: normal"><span style="FONT-FAMILY: Arial"><p> </p></span></b></p><p/><p/><p/><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><b style="mso-bidi-font-weight: normal"><span style="FONT-FAMILY: Arial">Bar Service </span></b><span style="FONT-FAMILY: Arial"> - <i style="mso-bidi-font-style: normal"><p/></i></span></p><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"><i style="mso-bidi-font-style: normal"><span style="FONT-FAMILY: Arial">Deco can provide bartenders for your event for $30 per hour along with all barware rentals, linens, tables, ice, mixers, etc.<span style="mso-spacerun: yes">  </span>You may set up your full bar through our bartenders or provide your own alcohol. <p/></span></i></p><p style="MARGIN: 0in 0in 0pt 0.25in" class="MsoNormal"/><p/></span><p style="MARGIN: 0in 0in 0pt" class="MsoNormal"><span style="FONT-FAMILY: Arial"><span style="mso-spacerun: yes"> </span><span style="mso-tab-count: 1">           </span><p/></span></p><p/></div></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table></div>
					</div>
				</td>
			</tr></table>
			</td>
