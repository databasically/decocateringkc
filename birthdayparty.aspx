...
<form name="aspnetForm" method="post" action="birthdayparty.aspx" id="aspnetForm">
<input type="hidden" name="MSO_PageHashCode" id="MSO_PageHashCode" value="161" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUBMGRkcl7dYh+40hAtf81tcF46W+CqSYM=" />
  ...
  <tr>
    <td class="MSC_PrimaryNavLinkFrame-On"><a href="./social.aspx" class="MSC_PrimaryNavLink-On">Social</a><table cellpadding="0" cellspacing="0" class="MSC_SecondaryNavFrame">
        ...
        <tr>
          <td class="MSC_SecondaryNavLinkFrame-On"><a href="./birthdayparty.aspx" class="MSC_SecondaryNavLink-On">Birthday Party</a></td>
        </tr>
        <tr>
          <td class="MSC_SecondaryNavTopSpace"></td>
        </tr>
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent" id="IWS_WH_Zone1"><div id="General_Content">Deco will take care of the all the details of the menu, so you can focus on the birthday boy or girl!  Call us today at 913.262.2816 or email us at <a href="mailto:courtney@decocateringkc.com">courtney@decocateringkc.com</a> to start planning today!</div></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table></div>
					</div>
				</td>
			</tr></table>
			</td>
