...
<head>
	<title>Corporate</title><meta name="Keywords" content="box lunches, kansas city corporate catering, kansas city corporate caterers, gourmet box lunches, last minute box lunches, kansas city, lenexa, overland park, shawnee, mission, fairway, westwood, north kansas city" /><meta name="Description" content="Our gourmet box lunches are made from only the best and freshest ingredients.  Our cookies are made from scratch with real butter and will tempt your taste buds.  Give us a call or send an email today to place your order." />
...
<form name="aspnetForm" method="post" action="corporate.aspx" id="aspnetForm">
<input type="hidden" name="MSO_PageHashCode" id="MSO_PageHashCode" value="551" />
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent" id="IWS_WH_Zone1"><div><strong><img src="images/aiaevent.jpg" style="WIDTH: 165px; HEIGHT: 124px"/></strong></div><div><strong>Amazing Food + </strong></div><div><strong>Reliable, Professional Service = A Great Meeting</strong></div> <div><br> </div><div>We know how important it is to have great food that will wow your group.  We know how important it is that everything arrives in perfect time, and just as you requested. We're here to make catering your next event simple and stress free.  Look over our menus and give us a call at 913.262.2816 or send us an email at <a href="mailto:info@decocateringkc.com">info@decocateringkc.com</a> to set up your next event.  </div> <div><br> </div><div><p/><p> </p></div></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table></div>
					</div>
				</td>
			</tr></table>
			</td>
