...
<head>
	<title>Sustainable Catering</title>
...
<form name="aspnetForm" method="post" action="sustainablecatering.aspx" id="aspnetForm">
<input type="hidden" name="MSO_PageHashCode" id="MSO_PageHashCode" value="141" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUBMGRkcl7dYh+40hAtf81tcF46W+CqSYM=" />
  ...
  <tr>
    <td class="MSC_PrimaryNavLinkFrame-On"><a href="./sustainablecatering.aspx" class="MSC_PrimaryNavLink-On">Sustainable Catering</a></td>
  </tr>
  <tr>
    <td class="MSC_PrimaryNavTopSpace"></td>
  </tr>
    ...
    <td class="MSC_PrimaryNavBottomSpace"></td>
				...
				<td class="MS_MasterBody">
					<div id="IWS_WH_Elem_Content" class="MSC_Body">
						<div id="IWS_WH_ZoneRowContainer"><table class="MS_WH_ZoneRow"><tbody><tr><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/><td valign="top" style="WIDTH: 98%" colspan="1" rowspan="1"><div class="MS_WH_ZoneContent" id="IWS_WH_Zone1"><div id="General_Content"> </div><p align="center"><img height="0" src="images/sustainability.jpg" style="MARGIN: 0px; WIDTH: 262px; HEIGHT: 195px" width="0"/></p> <div><br> </div><div><em><font size="3">Deco Catering is dedicated to doing our part for the environment and helping keep our community beautiful.  We believe that as business owners and citizens, we have a responsibility to not only recycle, but to get back to basics with our food and disposables.  Below is a list of just a few things we are doing to lessen our impact on the planet.  </font></em></div><p> </p><ul><li><div>Recycle.  This is the easiest thing we can do to help.  We recycle as much as possible.</div></li></ul><p> </p><ul><li><div>Biodegradable disposables.  We offer these products to our clients so that the trash from their lunch is not sitting in a landfill forever.  Most of our disposables that are not biodegradable are recyclable.</div></li></ul><p> </p><ul><li><div>Use less disposables.  We advise our clients that whenever their budget and the setup allows, they should not use disposables.  This adds an element of style to events, and saves a ton of waste.</div></li></ul><p> </p><ul><li><div>We grow fresh herbs.  This allows us not only to cook with the freshest herbs possible, but to reduce the carbon footprint involved with transporting them from other growing locations.</div></li></ul><p> </p><ul><li><div>Local foods.  We strive to use as many locally produced products and locally grown or raised foods as possible.  </div></li></ul> <div><br> </div></div></td><td style="WIDTH: 1%" colspan="1" rowspan="1" class="MS_WH_ZoneSpacing"/></tr></tbody></table></div>
					</div>
				</td>
			</tr></table>
			</td>
